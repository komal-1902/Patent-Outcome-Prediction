# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 10:56:26 2023
...
df_test = df_train[(df_train['filing_date'] >= '2016-01-26') & (df_train['filing_date'] <= '2016-01-31')]
df_train = df_train[(df_train['filing_date'] >= '2016-01-01') & (df_train['filing_date'] <= '2016-01-25')]
...
def extract_bert_embeddings(text,tokenizer,model):
    ...
    with torch.no_grad():
        ...
        embeddings = outputs.logits  # Using mean pooling for sentence embeddings
